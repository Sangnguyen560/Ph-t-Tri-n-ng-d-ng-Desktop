...
namespace Lab3_Demo
{
    public partial class frmSinhVien : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            qlsv.DocTuFile();
            LoadListView();
            tsslTongSo.Text = qlsv.DanhSach.Count().ToString();
        }
    ...
    SinhVien).MaSo.CompareTo(obj1.ToString());
        ...
        private void stastriplTongSV_Click(object sender, EventArgs e)
        {
    ...
    SinhVien).MaSo.CompareTo(obj1.ToString());
        ...
        private void tsslTongso_Click(object sender, EventArgs e)
        {
